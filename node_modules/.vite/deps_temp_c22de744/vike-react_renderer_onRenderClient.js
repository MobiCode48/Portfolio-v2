...
// node_modules/vike-react/dist/renderer/getHeadSetting.js
function getHeadSetting(headSetting, pageContext) {
  var _a;
  const config = (_a = pageContext.configEntries[headSetting]) == null ? void 0 : _a[0];
  if (!config)
    return void 0;
...
function getPageElement(pageContext) {
  ...
  let page = import_react.default.createElement(Layout, null, Page ? import_react.default.createElement(Page, null) : null);
  (pageContext.config.Wrapper || []).forEach((Wrapper) => {
    page = import_react.default.createElement(Wrapper, null, page);
  });
...
// node_modules/vike-react/dist/renderer/onRenderClient.js
var root;
var onRenderClient = (pageContext) => {
  var _a, _b, _c, _d;
  (_b = (_a = pageContext.config).onBeforeRenderClient) == null ? void 0 : _b.call(_a, pageContext);
  ...
  if (
    ...
    container.innerHTML !== "" && // Whether the page was already rendered to HTML. (I.e. whether this is the first client-side rendering.)
  ...
  (_d = (_c = pageContext.config).onAfterRenderClient) == null ? void 0 : _d.call(_c, pageContext);
};
