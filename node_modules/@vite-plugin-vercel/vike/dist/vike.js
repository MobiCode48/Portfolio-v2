...
function getRouteMatch(myroute) {
  ...
  if ("_routeMatch" in myroute.pageContextAddendum) {
    ...
    routeMatch = (_a = myroute.pageContextAddendum._routeMatches) == null ? void 0 : _a[0];
  } else if ("_debugRouteMatches" in myroute.pageContextAddendum) {
    routeMatch = (_b = myroute.pageContextAddendum._debugRouteMatches) == null ? void 0 : _b[0];
  }
  return routeMatch;
}
...
function vitePluginVercelVikeIsrPlugin() {
  return {
      ...
      async function getPagesWithConfigs() {
        ...
        if (isLegacy) {
          await Promise.all(pageFilesAll.map((p) => {
            var _a;
            return (_a = p.loadFile) == null ? void 0 : _a.call(p);
          }));
        }
