...
declare function vitePluginVercelVikeIsrPlugin(): Plugin;
declare function vitePluginVercelVikeCopyStaticAssetsPlugins(): Plugin;
declare function allPlugins(options?: Options): Plugin[];

export { type Options, assert, allPlugins as default, getOutDir, getOutput, getRoot, getSsrEndpoint, prerender, vikeVercelPlugin, vitePluginVercelVikeCopyStaticAssetsPlugins, vitePluginVercelVikeIsrPlugin };
